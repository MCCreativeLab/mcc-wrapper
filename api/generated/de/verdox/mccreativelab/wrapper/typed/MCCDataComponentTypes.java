...
public class MCCDataComponentTypes  {
	...
	public static final MCCReference<MCCDataComponentType<MCCDyeColor>> BASE_COLOR  = MCCPlatform.getInstance().getTypedKeyFactory().getKey(Key.key("minecraft", "base_color"), VANILLA_REGISTRY_KEY, new TypeToken<MCCDataComponentType<MCCDyeColor>>(){}).getAsReference();
