...
public class RegistryLookUpCommand<T> extends AbstractRegistryLookUpCommand<T, OpenRegistry<T>> {
    ...
    public RegistryLookUpCommand(@NotNull String name, String subCommand, OpenRegistry<T> registry, BiConsumer<Player, T> consumeEntry) {
        super(name, subCommand, registry, consumeEntry);
    }

    public RegistryLookUpCommand(@NotNull String name, OpenRegistry<T> registry, BiConsumer<Player, T> consumeEntry) {
